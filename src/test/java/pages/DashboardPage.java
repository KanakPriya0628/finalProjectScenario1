...
private WebDriver driver;
	...
	private By username=By.xpath("(//input[contains(@class,'oxd-input')])[2]");
	...
	private By recordfound=By.xpath("//div[contains(@class,'orangehrm-horizontal-padding')]//span[contains(@class,'oxd-text')]");
	...
	public void empSearchByUsername(String name)
	{
		...
		System.out.println(driver.findElement(recordfound).getText());
				
		driver.navigate().refresh();
	}
	
	public void empSearchByUserRole(String role)
	...
	public void empSearchByStatus(String stat) 
	{
